...
describe("Votings contract", function () {
    ...
    describe("Deployment and some transactions", function() {
        ...
        // создание голосования и участие в голосовании
        it("Transactions", async function () {

            await votings.addVoting("vote0", 0, [addr1.address, addr2.address, addr3.address]);  // lifetime = 0 для тестирования
        ...
        it("Finish&Withdraw", async function () {

            await votings.finish(0);
            await votings.withdraw(0);
